...
function draw() {
    ...
    let matAccumY = m4.multiply(rotateWithTimeY, matAccumX);
    let matAccum0 = m4.multiply(rotateWithTimeZ, matAccumY);
...
function CreateSurfaceData(normals, textures) {
    ...
    const R_START = 0.3,
        ...
        R_STEP = 0.1,
        T_STEP = 0.1;
    // const U_STEP = map(R_STEP, R_START, R_FINISH, 0, 1),
    //     V_STEP = map(T_STEP, T_START, T_FINISH, 0, 1);
